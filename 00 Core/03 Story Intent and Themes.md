...
Advanced technology is not an exemption from material reality. Its availability depends on energy, inputs, expertise, fabrication, maintenance, safety, institutions, and political choices. A useful invention can solve one problem while creating dependencies or new forms of power.
...
Cultures and ideologies are shaped by material conditions, generating selection pressure based on their suitability to the societies that contain them.

### Understanding is work

Communication across language, species, discipline, history, and trauma is slow, fallible work. It can nevertheless produce trust, joint action, and forms of belonging that neither side could achieve alone.

### Hope is practised

Hope is neither optimism without evidence nor the absence of catastrophe. It is the decision to preserve agency, care, and cooperation when circumstances make all three difficult.
...
| Survival and dignity | What must people preserve besides bare life when every resource is finite?            |
| Communication        | How can understanding emerge across language, species, culture, discipline, and fear? |
...
| Axis        | Tension                                                                          |
| ----------- | -------------------------------------------------------------------------------- |
| Exploration | Discovery and exchange versus non-interference, sovereignty, and harm prevention |
| Survival    | Crew priority versus obligations to local people and future consequences         |
| Society     | Individual initiative versus collective safety and accountability                |
| Identity    | Origin, biology, and inherited role versus chosen commitments and relationships  |
...
Detailed ethical positions belong with the characters and institutions that hold them. Use these questions to test arcs and encounters, not to require one definitive answer to every tension.
