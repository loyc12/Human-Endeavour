# Independent Technological Civilisations

**Status: Approved setting baseline; detailed contact history open**
...
3. **Contact posture — selected.** Contact is negotiated, imperfect, and materially asymmetric rather than a clean conquest narrative or frictionless enlightened exchange. External intervention may be regulated, contested, and sometimes refused, yet still exerts enormous pressure.

4. **Demographic pattern — selected.** A large home-region majority coexists with a smaller but very widely distributed connected-space diaspora. This avoids both tokenism and the implausible erasure of local demographic weight within a century and a half.
