...
The useful structural analogues are globalisation, networked information exchange, international organisations, multinational firms, international finance, standards bodies, trade regimes, uneven development, large federations or confederations, and interstellar commonwealth fiction. They are sources of questions, not one-to-one historical allegories.
...
- **Near-universal:** a standard, infrastructure dependency, or practice that almost all connected participants recognise.
...
Long pre-FTL separation makes heterogeneity foundational. Several centuries of FTL-enabled reconnection, trade, migration, communications, cultural exchange, and technological diffusion should nevertheless produce meaningful convergence. The intended tension resembles a globalised world: local difference persists within shared infrastructure, standards, technologies, markets, media, institutions, and reference points.

## Dependency Boundary

The answers below must remain conditional on the unresolved FTL, navigation, communication, and energy constraints in [[01 Technologies/01 Key Concepts/01 Spacetime Engineering|Spacetime Engineering]]. In particular, travel time, communications latency, route capacity, navigation risk, and the cost of moving people or mass determine which political scales, markets, and integration mechanisms are credible. Record new answers here as provisional where they depend on those unresolved constraints. This does not reopen or downgrade the already selected chronology, geography, contact, or numerical baselines.

Use [[99 Workshop/03 Travel and Settlement Calculations|Travel and Settlement Calculations]] when testing numerical assumptions. Its formulae distinguish voyage speed from exploration coverage and durable settlement growth; do not infer either of the latter from a vessel's maximum cruise speed.
...
1. **Chronology — selected:** [[02 World/01 Milky Way/01 Historical Timeline|Historical Timeline]], with [[02 World/01 Milky Way/04 Uplift, Adaptation, and Sovereignty|uplift]], [[02 World/01 Milky Way/05 Independent Near-Peer Civilisation|near-peer contact]], and the [[02 World/01 Milky Way/06 Wider Contact Horizon|wider contact horizon]] in their own references.
2. **Pre-FTL diaspora — selected:** [[02 World/01 Milky Way/02 Pre-FTL Diaspora|Pre-FTL Diaspora]] owns scale, settlement genealogy, historical layers, and slow exchange.
3. **Spatial continuity — selected:** [[02 World/01 Milky Way/03 Regions and Connectivity|Regions and Connectivity]] owns present extents, regional character, and the topology vocabulary.
...
Before promoting a conclusion into a reference document, trace its direct effects on the coalition's legitimacy, the vessel programme's political feasibility, species and uplift relations, the return journey's credibility, and what the crew would treat as normal. Update [[02 World/01 Milky Way/00 Milky Way Overview|the Milky Way social baseline]] only with approved results. Put detailed political, economic, or historical conclusions in their topical owner; retain clearly labelled open options separately. Update the [[99 Workshop/00 Revision Priorities|revision queue]] with a link rather than copying the conclusion.
